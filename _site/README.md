...
The Stars Laboratory is Dr. Chenang Liu's research group in the school of industrial engineering and management at Oklahoma State University.

Followings introduces the theme and the settingss of the website:

The website is built based on Centrarium [![Circle CI](https://circleci.com/gh/bencentra/centrarium/tree/master.svg?style=svg)](https://circleci.com/gh/bencentra/centrarium/tree/master), which is inspired by dirkfabisch's [Mediator](https://github.com/dirkfabisch/mediator) theme as well as [Type Theme](http://rohanchandra.github.io/type-theme/).
